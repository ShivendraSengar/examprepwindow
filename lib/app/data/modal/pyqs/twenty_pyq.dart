...
//
//     final twentrypyqpdf = twentrypyqpdfFromJson(jsonString);

import 'dart:convert';

Twentrypyqpdf twentrypyqpdfFromJson(String str) =>
    Twentrypyqpdf.fromJson(json.decode(str));

String twentrypyqpdfToJson(Twentrypyqpdf data) => json.encode(data.toJson());
...
class Twentrypyqpdf {
  ...
  factory Twentrypyqpdf.fromJson(Map<String, dynamic> json) => Twentrypyqpdf(
        code: json["code"],
        success: json["success"],
        message: json["message"],
        data: json["data"] == null
            ? []
            : List<ShowPdf>.from(json["data"]!.map((x) => ShowPdf.fromJson(x))),
      );
...
class ShowPdf {
  ...
  factory ShowPdf.fromJson(Map<String, dynamic> json) => ShowPdf(
        id: json["_id"],
