...
WeeklyTestseriesModal weeklyTestseriesModalFromJson(String str) => WeeklyTestseriesModal.fromJson(json.decode(str));

String weeklyTestseriesModalToJson(WeeklyTestseriesModal data) => json.encode(data.toJson());
...
class WeeklyTestseriesModal {
    ...
    factory WeeklyTestseriesModal.fromJson(Map<String, dynamic> json) => WeeklyTestseriesModal(
        code: json["code"],
        success: json["success"],
        message: json["message"],
        data: json["data"] == null ? [] : List<Testseries>.from(json["data"]!.map((x) => Testseries.fromJson(x))),
    );
...
class Testseries {
    ...
    factory Testseries.fromJson(Map<String, dynamic> json) => Testseries(
        ...
        courseId: json["courseId"] == null ? [] : List<CourseId>.from(json["courseId"]!.map((x) => CourseId.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "testName": testName,
        "testType": testType,
        "courseId": courseId == null ? [] : List<dynamic>.from(courseId!.map((x) => x.toJson())),
