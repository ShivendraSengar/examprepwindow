...
SubmitAnswerparams submitAnswerparamsFromJson(String str) => SubmitAnswerparams.fromJson(json.decode(str));

String submitAnswerparamsToJson(SubmitAnswerparams data) => json.encode(data.toJson());
...
class SubmitAnswerparams {
    ...
    factory SubmitAnswerparams.fromJson(Map<String, dynamic> json) => SubmitAnswerparams(
        userId: json["userId"],
        testId: json["testId"],
