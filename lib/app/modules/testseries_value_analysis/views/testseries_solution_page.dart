    ...
    Container(
        ...
        child: Obx(() {
          ...
          return SingleChildScrollView(
            child: Column(
              children: 
                 List.generate(controller.viewAnslist.length, (index) {
          var answerItem = controller.viewAnslist[index];
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        "${question.type}".toUpperCase().text.semiBold.color(Vx.white).make().p(5).box.roundedSM.color(Color.fromARGB(255, 233, 233, 10)).make(),
                        5.widthBox,
                        " + ${question.marks}".toUpperCase().text.semiBold.color(Vx.white).make().p(5).box.roundedSM.color(Vx.green700).make(),
                        5.widthBox,
                        " - ${question.negativeMarks}".toUpperCase().text.semiBold.color(Vx.white).make().p(5).box.roundedSM.color(Vx.red700).make(),
                        5.widthBox,
                      ],
                    ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Question : ${questionIndex + 1}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                        isSmallScreen ?
                        ...
                        Html(
                          ...
                          """,
                          style: {
                            "body": Style(fontWeight: FontWeight.bold, fontSize: FontSize(16.0)),
