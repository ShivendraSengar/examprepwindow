                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  child: Image.network(
                                    imageUrl +
                                        controller.arguments[0].toString(),
                                ...
                                children: [
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextField(
                                          ...
                                          controller:
                                              controller.correctReferralCode,
                                      ...
                                      Container(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            if (controller.correctReferralCode
                                                .text.isEmpty) {
                                              showToastMessage(
                                                  'Please Enter Referral Code',
                                                  "");
                                            } else {
                                              if (controller.finalCost.value <=
                                                  10) {
                                                showDialog(
                                                    context: context,
                                                    builder:
                                  ...
                                  Obx(() {
                                    if (controller.isReferralApplied.value &&
                                        !controller.isOwnReferral.value) {
                                      return Text(
                                      ...
                                      return Text(
                                        ...
                                        .referralErrorMessage.isNotEmpty) {
                                      return Text(
                                        controller.referralErrorMessage.value,
                                        style: TextStyle(color: Colors.red),
                                      ).pOnly(top: 8);
                                  ...
                                  Obx(() {
                                    if (!controller.isOwnReferral.value &&
                                      ...
                                      return buildRow('Referral Discount',
...
//Text(controller.chechreferal.first.email.toString()),
                        ...
                        buildRow('Course Price',
                            "Rs. ${controller.arguments[3]}" ?? ""),

                        Obx(() {
                          return controller.isCouponApplied.value != true
                              ? SizedBox()
                              : buildRow('Coupon Discount',
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Obx(() {
                                ...
                                if (controller.isReferralApplied.value &&
                                  ...
                                  totalAmount = double.tryParse(
                                    ...
                                    !controller.isReferralApplied.value) {
                                  totalAmount =
                                      controller.finalCost.value.toDouble() ??
                                          0.0;
                                } else if (!controller.isCouponApplied.value &&
                                    controller.isReferralApplied.value) {
                                  totalAmount = controller
                              ...
                              Container(
                                ...
                                print(
                                    "Time duration${controller.arguments[7]}");
